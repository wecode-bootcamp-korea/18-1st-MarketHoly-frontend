      ...
      <>
        <div className="sectionHeader">
          <div className="headerName">
            <h1>늘 사는 것</h1>
            <div className="headerInfo">늘 사는 것으로 등록하신 상품 목록입니다.</div>
          </div>
        </div>
          ...
          return (
            <div className="wishItem" key={e.id}>
              ...
              <div className="wishIteminfo">
                ...
                <div className="wishItemprice">{e.price.toLocaleString(navigator.language)}원</div>
              </div>
              <div className="wishItemOption">
                <button className="wishBasket">장바구니 담기</button>
                <button className="wishDelete" onClick={removeWhishitem} value={e.id}>
                  삭제
                </button>
              </div>
            </div>
        ...
        {wishItem.length == 0 && <div className="notOder">늘 사는 상품 내역이 없습니다.</div>}
